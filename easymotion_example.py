...
class JumpGroupGenerator:
    ...
    def __init__(self, view, character, placeholder_chars, case_sensitive):
        ...
        self.jump_target_groups = self.create_jump_target_groups()# Array of dicts, (k, v) = (placholder, match region)
...
class EasyMotionCommand(sublime_plugin.WindowCommand):
    ...
    # Deactive Vintage plugin and activate 'easy_motion_mode'
...
# Insert placeholder characters into text
class SetTextEmCommand(sublime_plugin.TextCommand):
    ...
    def run(self, edit):
        ...
        for placeholder_char in CURRENT_JUMP_GROUP.keys():
            # Replace contents of a jump region with the placeholder_char string
